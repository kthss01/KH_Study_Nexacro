...
public class EmployeeDAO {
	...
	public List selectList(Connection con, Map iMap) throws Exception {
	...
	public int updateEmployee(Connection con, Map newMap) throws Exception {
		...
		PreparedStatement pstmt = null;
		String sql = "UPDATE EMPLOYEE SET " + "EMP_NAME = ? , " + "EMP_NO = ? , " + "EMAIL = ? , " + "PHONE = ? , "
				+ "DEPT_CODE = ? , " + "SALARY = ? , " + "BONUS = ? , " + "MANAGER_ID = ?, " + "HIRE_DATE = ? , "
				+ "ENT_DATE = ? , " + "ENT_YN = ? " + "WHERE EMP_ID = ? ";
