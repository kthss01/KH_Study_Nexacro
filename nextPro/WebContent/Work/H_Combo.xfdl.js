(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("Static00","57","35","167","56",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("> 기본 콤보박스");
            this.addChild(obj.name, obj);

            obj = new Combo("cbo_01","50","91","220","59",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            ...
            obj = new Edit("edt_01","320","91","214","59",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            this.addChild(obj.name, obj);
