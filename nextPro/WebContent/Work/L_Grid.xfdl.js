(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Grid("Grid00","39","19","881","231",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_binddataset("ds_emp");
            obj.set_cellsizingtype("col");
            obj.set_autofittype("col");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"68\"/><Column size=\"73\"/><Column size=\"111\"/><Column size=\"103\"/><Column size=\"87\"/><Column size=\"106\"/><Column size=\"45\"/><Column size=\"70\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"45\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"ID\"/><Cell col=\"1\" text=\"Name\"/><Cell col=\"2\" text=\"Email\"/><Cell col=\"3\" text=\"Phone\"/><Cell col=\"4\" text=\"Dept.\"/><Cell col=\"5\" text=\"Salary\"/><Cell col=\"6\" text=\"Bonus\"/><Cell col=\"7\" text=\"Manager\"/><Cell col=\"8\" text=\"Hire Date\"/><Cell col=\"9\" text=\"Ent Date\"/><Cell col=\"10\" displaytype=\"checkboxcontrol\"/></Band><Band id=\"body\"><Cell text=\"bind:EMP_ID\" textAlign=\"center\"/><Cell col=\"1\" text=\"bind:EMP_NAME\"/><Cell col=\"2\" text=\"bind:EMAIL\" tooltiptext=\"bind:EMAIL\"/><Cell col=\"3\" text=\"bind:PHONE\" displaytype=\"mask\" edittype=\"mask\" maskeditformat=\"###-####-####\" maskedittype=\"string\"/><Cell col=\"4\" text=\"bind:DEPT_CODE\" displaytype=\"combotext\" edittype=\"combo\" combodataset=\"ds_dept\" combocodecol=\"DEPT_CD\" combodatacol=\"DEPT_NAME\"/><Cell col=\"5\" text=\"bind:SALARY\" displaytype=\"number\" edittype=\"normal\"/><Cell col=\"6\" text=\"bind:BONUS\" displaytype=\"number\"/><Cell col=\"7\" text=\"bind:MANAGER_ID\" displaytype=\"combotext\" edittype=\"none\" combodataset=\"ds_emp\" combocodecol=\"EMP_ID\" combodatacol=\"EMP_NAME\"/><Cell col=\"8\" text=\"bind:HIRE_DATE\" displaytype=\"calendarcontrol\" edittype=\"date\"/><Cell col=\"9\" text=\"bind:ENT_DATE\" displaytype=\"calendarcontrol\" edittype=\"date\"/><Cell col=\"10\" text=\"bind:ENT_YN\" edittype=\"checkbox\" displaytype=\"checkboxcontrol\" checkboxtruevalue=\"Y\" checkboxfalsevalue=\"N\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Edit("Edit00","38","270","172","48",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            this.addChild(obj.name, obj);

            obj = new Combo("Combo00","38","386","172","48",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            ...
            obj = new MaskEdit("MaskEdit00","38","328","172","48",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            this.addChild(obj.name, obj);
            ...
            obj = new BindItem("item0","Combo00","value","ds_emp","DEPT_CODE");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item1","Edit00","value","ds_emp","EMP_NAME");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item2","MaskEdit00","value","ds_emp","SALARY");
            this.addChild(obj.name, obj);
            obj.bind();
        };
        ...
        // User Script
        this.registerScript("L_Grid.xfdl", function() {
